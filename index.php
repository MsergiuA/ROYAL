...
<html>
    ...
    <body>
        <div class="container-fluid">
            <div>
                <div class="row">
                    <div class="header col-md-12 col-xs-12 tel-email-container">
                        <p>T 86-21-153163733076 | E <a href="#">Contact@RoyalTec.com.cn</a></p>
                    </div>
                </div>
                <div class="row">
                    <div class="navbar col-md-12 col-xs-12 nav-bar-ul" style="text-align: center;">
                        <div class="col-md-6 offset-1">
                            <nav class="nav d-flex justify-content-between">
                                <a class="p-2 col-md-2 menuItem" href="#">Royal</a>
                                <a class="p-2 col-md-2 menuItem" href="#">Products</a>
                                <a class="p-2 col-md-2 menuItem" href="#">Application</a>
                                <a class="p-2 col-md-2 menuItem" href="#">Services</a>
                                <a class="p-2 col-md-2 menuItem" href="#">Article</a>
                                <a class="p-2 col-md-2 menuItem" href="#">Contact</a>
                            </nav>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 carrousel-no-padding-class">
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="resources/images/sew.jpeg" alt="First slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="resources/images/second.jpeg" alt="Second slide">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="resources/images/third.jpeg" alt="Third slide">
                                </div>
                            </div>
        ...
        $('.menuItem').hover(function(){
            ...
            if(linkContent == 'royal') {
                ...
                $(products).each(function (i) {
                    var content = '<a class="p-2 col-md-2 hidden-element-text" href="#">' + products[i] + '<hr class="custom-line-for-menu-items"></a>';
                    $('.body-of-hidden-div').append(content);
                });
            }else{
                $('.body-of-hidden-div').empty();
